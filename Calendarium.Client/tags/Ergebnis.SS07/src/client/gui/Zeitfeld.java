...
public class Zeitfeld extends JPanel implements ActionListener, FocusListener,
	...
	void create() {
		...
		minuten.setBorder(new CustomBorder(Color.black, false, false, true,
				false));
		...
		stunde.setBorder(new CustomBorder(Color.black, false, false, true,
				false));
	...
	public String getTime() {
		...
		return fill[0] + stunde.getText() + TIMETOKEN + fill[1]
				+ minuten.getText();
	}
	...
	// FocusListener //
	// /////////////////////////////////////////////////////////////////////////////////////
	public void addFocusListener(FocusListener listener) { // mFocusListenerList.add(FocusListener.class,
		// listener);by
		// johnny
	}
			...
			for (int i = listeners.length - 2; i >= 0; i -= 2) {
				if (listeners[i] == FocusListener.class) {
					if (e.getID() == FocusEvent.FOCUS_GAINED) {
						((FocusListener) listeners[i + 1])
								.focusGained(newEvent);
					} else {
