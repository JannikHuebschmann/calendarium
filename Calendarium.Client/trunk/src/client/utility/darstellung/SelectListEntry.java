...
public class SelectListEntry implements ActionListener, ListSelectionListener,
	...
	public SelectListEntry(boolean hasBtns) {
		// initialisieren
	...
	public void createModel() {
		...
		Vector allPersons = Data.personen.getOrderedList();

		if (allPersons != null) {
			Enumeration e = allPersons.elements();
			...
			if (len >= nameOld.length()) {
				if (nameNew.compareTo(nameOld) > 0) {
					...
					if (isGreater == 0
						...
						String persName = person.getNameLang();
	...
	public void valueChanged(ListSelectionEvent e) {
		if (e.getFirstIndex() >= 0) {
			...
			name.setText(person.getNameLang());
	...
	class SelectionCellRenderer extends JLabel implements ListCellRenderer {
		...
		public Component getListCellRendererComponent(JList list, Object value,
			...
			setText(person.getNameLang() + " (" + person.getKuerzel() + ")");
