...
public class Datumsfeld extends JPanel implements ActionListener,
		FocusListener, data.Shared {
	...
	void create() {
		...
		monat
				.setBorder(new CustomBorder(Color.black, false, false, true,
						false));
	...
	public GregorianCalendar getDateGreg() {
		return new GregorianCalendar(
				Integer.valueOf(jahr.getText()).intValue(), Integer.valueOf(
						monat.getText()).intValue() - 1, Integer.valueOf(
