 ...
 * Nfkt -> Notification
 * 
 * this class administered the dates
 */
...
{   
    ...
    /**
     * this is the run function. here will executed events, set done.
     */
    public void run()
    {   
        while(true)
    ...
    /**
     * this function add notification sorted
     * @param notifier ( a Notification, which should added)
     */
    ...
    /**
     * this function add a Notification
     * @param entry
     */
    ...
    /**
     * this function remove a date
     * @param t (no. form notificationlist)
     */
    ...
    /**
     * this function remove Eventsmessages
     * @param t (no. form notificationlist)
     */
    ...
    /**
     * this class allows to create and set done events
     * @author unkown, edit by Ludger
     *
     */
    class Notifier
    {
