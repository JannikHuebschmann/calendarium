 ...
 * This is the class-declaration of the ToDoSetRemote-class.
 */
public class ToDoSetRemote extends UnicastRemoteObject implements interfaces.ToDoSetInterface
{
    ...
    /**
     * Constructor of ToDoSetRemote-class
    ...
    ///////////////////////////////////////////////////////////////////////////////////
	/**
	 * This is a private function that loads several values from
	 * file "...\todo.dat".
	 */
    private void load()
    {
    ...
    /////////////////////////////////////////////////////////////////////////////////
	/**
	 * This is a public function that saves several values to file
	 * "...\todo.dat".
	 */
    ...
    /**
     * This is a private function that sends the message that there
     * is a new todo-entry.
    ...
    /**
     * This is a private function that sends a todo-entry-deleted
     * message.
     * @param toDo (ToDo object)
     * @param allOfSerie (boolean value) 
     */
    ...
    /**
     * This is a private function that sends a todo-entry-changed
     * message.
     * @param toDoAlt (ToDo object)
     * @param toDoNeu (ToDo object)
     */
    ...
    @SuppressWarnings("unchecked")
    /**
     * This private function inserts a todo-object into the todo-
     * list.
     * @param toDo (ToDo object)
     */
    ...
    // remove
    /**
     * This private function removes a todo-object from the list.
     * @param toDo (ToDo object)
     */
    ...
    @SuppressWarnings("unchecked")
    /**
     * This private function updates the todo-object in the list.
     * @param toDoAlt (ToDo object)
     * @param toDoNeu (ToDo object)
     */
    ...
    @SuppressWarnings("unchecked")
    /**
     * This private function adds a todo-object to the todo-list.
     * @param toDo (ToDo object)
     */
    ...
    /**
     * This private function removes the specifies todo-object from
     * the list.
     * @param toDo (ToDo object)
     */
    ...
    // Person löschen
    /**
     * This public function deletes the specified Person-object.
	 ...
	 * @param personenliste (Vector object)
	 * @return Vector[] (an array of Vector objects)
	 * @throws RemoteException
	 */
    ...
    // Daten säubern
	/**
	 * This public function tidys up the database by deleting all
	...
	// ToDo anlegen
    /**
     * This public function creates a new todo-entry.
	...
	// ToDo löschen
	/**
	 * This public function removes the specified todo-entry.
	 * @param kuerzel (String)
	 * @param toDo (ToDo object)
	...
	@SuppressWarnings("unchecked")
	/**
	 * This public function changes/updates a certain todo-entry.
	 * @param kuerzel (String)
	 * @param toDoNeu (ToDo object)
	 * @throws RemoteException
	 */
	...
	/**
	 * This public function sends the message that the owner of a
	 * todo-entry has no right to execute this entry.
	 * @param toDo (ToDo object)
