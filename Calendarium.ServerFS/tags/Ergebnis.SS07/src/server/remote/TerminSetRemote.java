 ...
 * This is the class-declaration of the TermineSetRemote-class.
 */
public class TerminSetRemote extends UnicastRemoteObject implements interfaces.TerminSetInterface
{
    ...
    /**
     * Constructor of TerminSetRemote-class
    ...
    ///////////////////////////////////////////////////////////////////////////////////
    /**
     * This private function loads serveral values from file
     * "...\termine.dat".
     */
    private void load()
    {
    ...
    /////////////////////////////////////////////////////////////////////////////////
    /**
     * This public function saves several values to file
     * "...\termine.dat".
     */
    ...
    /**
     * This private function sends the message that indicates a
     * new date.
     * @param termin (Termin object)
     */
    ...
    /**
     * This private function sends a message that indicates a
     * cancellation of an appointment.
     * @param termin (Termin object)
     * @param allOfSerie (boolean)
     */
    ...
    /**
     * This private function sends a message that indicates a
     * change of an appointment.
     * @param terminAlt (Termin object)
     * @param terminNeu (Termin object)
     */
    ...
    /**
     * get-function
     * @param persHashAlt (Hashtable)
     * @param terminAlt (Termin object)
     * @param persHashNeu (Hashtable)
     * @param terminNeu (Termin object)
     * @return String
     */
    ...
    /**
     * This private function inserts the specified appointment.
     * @param termin
	 */
	@SuppressWarnings("unchecked")
    ...
    // remove
	/**
	 * This private function deletes the specified appointment.
	 * @param termin (Termin object)
	 */
    ...
    @SuppressWarnings("unchecked")
    /**
     * This private function exchanges the old appointment with
     * a new one (updating the appointment).
     * @param terminAlt (Termin object)
     * @param terminNeu (Termin object)
     */
    ...
    @SuppressWarnings("unchecked")
    /**
     * This private function adds an appointment to the actual list.
     * @param termin (Termin object)
     */
    ...
    /**
     * This private function deletes an appointment.
     * @param termin (Termin object)
     */
    ...
    // Person löschen
    /**
     * This public function removes a person from an appointment.
    ...
    /**
     * get-function
     * @param vomDat (Datum object)
     * @param personenListe (Vector object)
     * @return Vector
     */
    ...
    /**
     * get-function
     * @param vonDat (Datum object)
     * @param bisDat (Datum object)
     * @param personenliste (Vector object)
     * @return Vector[] (a Vector-array)
     */
    ...
    /**
     * get-function
     * @param persons (Hashtable)
     * @param bgn (Datum object)
     * @param end (Datum object)
     * @param wk (boolean value)
     * @return Vector
     * @throws RemoteException
     */
    ...
    // Daten säubern
    /**
     * This public function cleans the database by removing all
     * entries until a certain date.
     * @param person (Person object)
     * @param bis (Datum object)
     * @throws RemoteException
     */
   ...
   // Termin anlegen
    /** 
     * This public function creates a new appointment.
    ...
    */
    ...
    // Termin löschen
	/**
	 * This public function deletes an appointment.
	 * @param kuerzel (String)
	 * @param termin (Termin object)
	 * @param serie (boolean value)
	 * @throws RemoteException
	 */
    public void delete(String kuerzel, Termin termin, boolean serie) throws RemoteException
    {
        ...
        @SuppressWarnings("unchecked")
        /**
         * This public fuction changes/updates an appointment.
         * @param kuerzel (String)
         * @param terminNeu (Termin object)
         * @throws RemoteException
         */
        ...
        /**
         * This function sends the message that the person(s) do
         * not have the permission to create an entry.
         * @param termin (Termin object)
         * @param persons (Vector object)
         * @throws RemoteException
         */
