...
/** builds sql clause "attribute < value"
  */
public class LessThanCriteria extends SelectionCriteria
{
    public LessThanCriteria(ClassMap map, String attr, Object val)
    {
        super(map,attr,val);
        /*  Tobi:
         *  Generating "LessThanCriteria"-Object as specified in SelectionCriteria.java
         */
    }
