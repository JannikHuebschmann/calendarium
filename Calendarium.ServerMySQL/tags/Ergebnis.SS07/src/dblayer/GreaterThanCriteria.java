...
/** builds sql clause "attribute > value"
  */
public class GreaterThanCriteria extends SelectionCriteria
{
    public GreaterThanCriteria(ClassMap map, String attr, Object val)
    {
        super(map,attr,val);
        /*  Tobi:
         *  Generating "GreaterThanCriteria"-Object as specified in SelectionCriteria.java
         */
    }
