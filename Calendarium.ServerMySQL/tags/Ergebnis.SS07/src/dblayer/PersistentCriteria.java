...
public abstract class PersistentCriteria
{
    ...
    {
        if (sql.indexOf("THE") >= 0) sql = new String(sql+addCloseBrace());
        /*  Tobi:
         *  Hint for Nested Table Problem
         *  "THE" is associated with Data Type from Inner Tables
         *  
         *  Probably this is a place where Joins have to be inserted
         */
        
        // if inner table is selected ")" must end SFW
